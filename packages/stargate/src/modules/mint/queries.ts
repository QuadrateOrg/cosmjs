...
import { Params } from "@quadrateorg/quadjs-types/cosmos/mint/v1beta1/mint";
import { QueryClientImpl } from "@quadrateorg/quadjs-types/cosmos/mint/v1beta1/query";

import { createProtobufRpcClient, decodeCosmosSdkDecFromProto, QueryClient } from "../../queryclient";

/**
 * Like Params from "@quadrateorg/quadjs-types/cosmos/mint/v1beta1/mint"
